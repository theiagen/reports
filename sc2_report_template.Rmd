...
The figures shown here were generated using sequence data processed with the [Titan_Augur_Run WDL Workflow](https://github.com/theiagen/public_health_viral_genomics/blob/main/workflows/wf_titan_augur_run.wdl).

Titan_Augur_Run  uses [Augur](https://github.com/nextstrain/augur) to perform multiple-sequence alignment (MSA) and to build a Maximum-Liklihood tree of all SARS-CoV-2 genomes provided. The MSA file is used to generate a pairwise-snp distance matrix with [snp-dists](https://github.com/tseemann/snp-dists).
